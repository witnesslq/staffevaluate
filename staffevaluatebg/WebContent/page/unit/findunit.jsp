...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//	alert(page);
				location.href = "unit_listP?currentPage="+page;
			}
			...
			function updateInfo() {
				...
				//alert(chestr);
				var chestr = $(arr).val();
				location.href = "unit_updateInfo.action?id="+chestr;
			...
			function doDelete(){
				...
				alert(chestr);
				window.location ="unit_delete.action?ids="+chestr;
			}
		</script>
			...
			<div class="backsize">
				...
				<div class="infomation">
					<div class="information_list">
						<table>
							...
							<s:iterator value="list" var="u" status="ss">
							<tr class="tbody_tr">
								<td height="20px"><input type="checkbox" value="${u.id }"name="cbunit" class="che"/></td>
								<td>${ss.index +1}
				...
				<div class="page_session">
					...
					<div class="page_select">
						<a href="unit_listP.action?currentPage=1">
							<div class="ic"><img src="images/u01.png" title="点击跳转到首页" /></div>
						</a>
						
						
						<s:if test="currentPage>1">
							<a href="unit_listP.action?currentPage=${currentPage-1}">
						...
						<a href="unit_listP.action?currentPage=${pageCount}">
