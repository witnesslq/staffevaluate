...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//	alert(page);
				location.href = "role_listAll?currentPage="+page;
			}
			...
			function updateInfo() {
				...
				var chestr = $(arr).val();
			//	alert(chestr);
				location.href = "role_updateInfo.action?id="+chestr;
			}
			...
			function doDelete(){
				...
				alert('确定删除'+chestr+"?");
				window.location.href="role_delete.action?ids="+chestr;
			}
		</script>
			...
			<div class="backsize">
					...
					<div class="information_list">
						<table>
							...
							<tr class="thead_tr">
								...
								<th class="cols_unitname">角色</th>
							</tr>
							<!-------------------------------------------表体-------------------------------------------->
							</thead>
							<tbody id="tbody-result">  
							<s:iterator value="list" var="r" status="ss">
							<tr class="tbody_tr">
								<td height="20px"><input type="checkbox" value="${r.role_id }"name="cbunit" class="che" /></td>
								<td>${ss.index +1}
								<input type="hidden" value="${r.role_id }" id="ids"name="ids"/>
								</td>
								<td>${r.name}</td>
							</tr>
							</s:iterator>
				...
				<div class="page_session">
					...
					<div class="page_select">
						<a href="role_listAll.action?currentPage=1">
							<div class="ic"><img src="images/u01.png" title="点击跳转到首页" /></div>
						</a>
						
						
						<s:if test="currentPage>1 ">
							<a href="role_listAll.action?currentPage=${currentPage-1}">
						...
						<a href="role_listAll?currentPage=${pageCount}">
				...
				<div class="footer">
					<div class="function_sesstion">
						<div class="public new_add" title="点击跳转到新增界面">
						   <a href="page/role/addrole.jsp" class="link"><img src="images/01.png" class="ico"/></a>
						</div>
