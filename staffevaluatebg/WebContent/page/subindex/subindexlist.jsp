...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//	alert(page);
				location.href = "subindex_listAll?currentPage="+page;
			}
			...
			function updateInfo() {
				...
				//alert(chestr);
				var chestr = $(arr).val();
				location.href = "subindex_updateInfo.action?id="+chestr;
			}
			...
			function doDelete(){
				...
				alert('确定删除'+chestr+"?");
				window.location.href="subindex_delete.action?ids="+chestr;
			}
		</script>
			...
			<div class="backsize">
					...
					<div class="information_list">
						<table>
							...
							<tr class="thead_tr">
								...
								<th class="cols_unitname">分项指标</th>
							</tr>
							<!-------------------------------------------表体-------------------------------------------->
							</thead>
							<tbody id="tbody-result">  
							<s:iterator value="list" var="sub" status="ss">
							<tr class="tbody_tr">
								<td height="20px"><input type="checkbox" value="${sub.id }"name="cbunit" class="che" /></td>
								<td>${ss.index +1}
								<input type="hidden" value="${sub.id }" id="ids"name="ids"/>
								</td>
								<td>${sub.name}</td>
							</tr>
							</s:iterator>
				...
				<div class="page_session">
					...
					<div class="page_select">
						<a href="subindex_listAll.action?currentPage=1">
							<div class="ic"><img src="images/u01.png" title="点击跳转到首页" /></div>
						</a>
						
						
						<s:if test="currentPage>1 ">
							<a href="subindex_listAll.action?currentPage=${currentPage-1}">
						...
						<a href="subindex_listAll?currentPage=${pageCount}">
				...
				<div class="footer">
					<div class="function_sesstion">
						<div class="public new_add" title="点击跳转到新增界面">
						   <a href="page/subindex/addsubindex.jsp" class="link"><img src="images/01.png" class="ico"/></a>
						</div>
