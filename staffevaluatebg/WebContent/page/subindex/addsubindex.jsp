...
function submit1(){
	var subindex = document.getElementById("name").value;
	if(subindex!==null && subindex!=="undefined" && subindex!==""){
...
<div class="back1" style="border:solid 1px gray; ">
	...
	<table style="margin-left:100px;margin-top:30px">
		<tr>
			<td><span style="font-size: 20px;;font-family:微软雅黑; ">新增分项指标名称：</span></td>
			<td><input type="text" name="subindex.name" id="name"/></td>
		</tr>
	</table>
	</div>
	<div class="d1" >
