...
<script type="text/javascript">
	...
	function back(){
		window.location = "post_listAll.action";
	}
</script>
<style type="text/css">
	.back1{
...
<div class="back1" style="border:solid 1px gray; ">
	...
	<table style="margin-left:100px;margin-top:30px">
		<tr>
			<td><span style="font-size: 20px;font-family:微软雅黑; ">原岗位名称：</span></td>
			<td><input type="text"  value="${post.name }" disabled/>
			<input name="id" type="hidden" value="${post.post_id }" name="post.post_id"/></td>
		</tr>
		<tr>
			<td><span style="font-size: 20px;;font-family:微软雅黑; ">*岗位名称：</span></td>
