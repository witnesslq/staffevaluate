...
<body>
	<div class="title"><div class="titlew">政策法规录入</div></div>
	<div class="back" >
		<form action="uploadzcfg_add.action" method="post">
		<div >
			<div class="tishi" >请输入要显示的政策法规文本：</div>
			<div class="font">
				<span>请选择前台要显示的字体大小：</span>
				<select name="zcfg.fsize">
		...
		<div class="content" >
				<textarea rows="30" cols="120" name="zcfg.zcfgxt" id="content"></textarea>
		</div>
		<div class="s1">
