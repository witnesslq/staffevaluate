...
public class UserEvaluateServiceImpl implements UserEvaluateService {
	...
	@Override
	public Integer getRowCount(String sat) {
		return userEvaluateDao.getAllRowCount1(sat);
	}

	@Override
	public Integer getAllRowCount() {
		return userEvaluateDao.getAllRowCount();
	}

	@Override
	public void updateReturn(String ids) {
		userEvaluateDao.updateReturn(ids);
	}

	@Override
	public void updateValid(String ids) {
		userEvaluateDao.updateValid(ids);
	}
