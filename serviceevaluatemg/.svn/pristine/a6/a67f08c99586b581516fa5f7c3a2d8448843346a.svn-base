...
<body>
	<div
		style="position: absolute; background-image: url(images/main_zcfg.jpg); background-size: cover; width: 1360px; height: 900px; top: 10;">
		<img alt="" src="images/zhuye.jpg"
			style="position: absolute; left: 1230px; top: 135px" onclick="home()">
		<div class="homeBody">
			<span class="xtjj"><s:property value="zcfg.zcfgtxt"
					escape="false" /></span>
		</div>
	</div>
