...
td{FONT-SIZE:9pt;font-family:"微软雅黑"}
		...
		window.onload=function(){
		    ...
		    document.getElementById("satisfaction").src="images/biaoyang.png";
			}else if(satisfaction=="建议"){
				 document.getElementById("satisfactionBg").style.backgroundImage="url(images/u25.png)";
				    document.getElementById("size2").style.color="white";
		    document.getElementById("satisfaction").src="images/jianyi.png";
			}else if(satisfaction=="批评"){
				 document.getElementById("satisfactionBg").style.backgroundImage="url(images/u27.png)";
				    document.getElementById("size2").style.color="piping.png";
		    document.getElementById("satisfaction").src="images/piping.png";
			}
	...
	height:128px;">
				...
				<right class="right">
					...
					<i class="tu1"style="width: 100px;height: 50px;margin: 37px 0 0 140px;cursor: pointer;"><a href="staff_login.action" target="_parent"><img src="images/002.png"/></a></i>
